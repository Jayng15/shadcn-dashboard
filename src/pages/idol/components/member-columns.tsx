      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              onClick={() =>
                (table.options.meta as unknown as { editMember: (member: Member) => void })?.editMember?.(member)
              }
            >
              Chỉnh sửa
            </DropdownMenuItem>
            <DropdownMenuItem
              ...
              onClick={() =>
                (table.options.meta as unknown as { deleteMember: (member: Member) => void })?.deleteMember?.(member)
              }
            >
              Xóa
            </DropdownMenuItem>
